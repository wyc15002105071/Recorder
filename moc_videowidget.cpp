...
QT_MOC_LITERAL(1, 12, 20), // "onVideoWidgetCreated"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 13) // "onStartUpdate"

    },
    "VideoWidget\0onVideoWidgetCreated\0\0"
    "onStartUpdate"
};
...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onVideoWidgetCreated(); break;
        case 1: _t->onStartUpdate(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::onVideoWidgetCreated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (VideoWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::onStartUpdate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void VideoWidget::onVideoWidgetCreated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void VideoWidget::onStartUpdate()
{
